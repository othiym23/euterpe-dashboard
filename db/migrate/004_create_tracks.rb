class CreateTracks < ActiveRecord::Migration
  def self.up
    create_table :tracks do |t|
      ...
      t.column :sort_order, :integer, :default => "", :null => false
      t.column :artist_name, :string, :default => "", :null => false
      t.column :artist_sort_order, :integer, :default => "", :null => false
      ...
      t.column :disc_id, :string, :null => false
      t.column :comment, :string, :default => "", :null => false
      t.column :encoder, :string, :default => "", :null => false
